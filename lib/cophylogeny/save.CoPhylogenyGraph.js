...
class CoPhylogenyGraph {
    ...
    addPersistentClass(classname, selector, apply=true) {
        if (! this.persistentClasses.hasOwnProperty(classname)) {
            this.persistentClasses[classname] = [];
        }
    ...
    render(leftNw, rightNw) {
        ...
        this.make_binary(leftNw);
        this.make_binary(rightNw);
...
// as per https://stackoverflow.com/questions/32657516/how-to-export-a-es6-class-properly-in-node-4
var CoPhylogenyGraphModule = function() {};
